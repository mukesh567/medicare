...
const Profile = ({ doctorData }) => {
    ...
    const handleReusableInputChangeFunction = (key, index, e) => {
    ...
    //Qualifications section's function
    const addQualification = (e) => {
        e.preventDefault();
        addItem("qualifications", { startingDate: "", endingDate: "", degree: "B.tech", university: "Bikaner Medical College" })
    }

    const handleQualificationChange = (e, index) => {
        handleReusableInputChangeFunction('qualifications', index, e);
    }
    ...
    //Experiences section's function
    const addExperience = (e) => {
        e.preventDefault();
        addItem("experiences", { startingDate: "", endingDate: "", position: "Senior Surgeon", hospital: "Bikaner Medical" })
    }

    const handleExperiencesChange = (e, index) => {
        handleReusableInputChangeFunction('experiences', index, e);
    }
    ...
    //TimeSlots section's function
    const addTimeSlot = (e) => {
        e.preventDefault();
        addItem("timeSlots", { day: "Sunday", startingTime: "11:00", endingTime: "04:30" })
    }

    const handleTimeSlotChange = (e, index) => {
        handleReusableInputChangeFunction('timeSlots', index, e);
    }
