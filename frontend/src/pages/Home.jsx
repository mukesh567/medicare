...
const Home = () => {
  return <>
    ...
    <section className="hero_section pt-[68px] 2xl:h-[800px] ">
      <div className="container">
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between ">
          ...
          <div className="flex gap-[30px] justify-end ">
            <div >
              <img src={heroImg01} className='w-full' alt="Hero image not found" />
            </div>
            <div className='mt-[30px' >
              <img src={heroImg02} className='w-full mb-[30px]' alt="Hero image not found" />
              <img src={heroImg03} className='w-full' alt="Hero image not found" />
            </div>
          </div>
             ...
             md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg-pb[26px] rounded-[10px] ">
              ...
              <div className="flex items-center justify-between ">
                ...
                <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center 
                  ...
                  <img src={videoIcon} alt="Video icon image" />
                </span>
              </div>
